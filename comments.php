...
<div id="comments" class="comments-area _comments">
  ...
  $fields =  array(
    'author' =>
      '<p class="comment-form-author _comments__field"><label for="author" class="_comments__field-label">' . __( 'Name', 'domainreference' ) . '</label> ' .
    ...
    'email' =>
      '<p class="comment-form-email _comments__field"><label for="email" class="_comments__field-label">' . __( 'Email', 'domainreference' ) . '</label> ' .
      ( $req ? '<span class="required _comments__field-required">*</span>' : '' ) .
    ...
    'url' =>
      '<p class="comment-form-url _comments__field"><label for="url" class="_comments__field-label">' . __( 'Website', 'domainreference' ) . '</label>' .
  ...
  comment_form(array(
    ...
    'logged_in_as' => '<p class="logged-in-as _comments__user">' .
      sprintf(
      __( 'Logged in as <a href="%1$s" class="_comments__user-name">%2$s</a>. <a href="%3$s" class="_comments__logout-link" title="Log out of this account">Log out?</a>' ),
